...
if __name__ == "__main__":
    ...
    def main(term):
        ...
        term.addstr(6, 0, "Warning", curses.color_pair(6))
        term.addstr(7, 0, "Warning", curses.color_pair(12))
        term.addstr(8, 0, "Danger", curses.color_pair(1))
        term.addstr(9, 0, "Danger", curses.color_pair(7))
        term.getch()
    curses.wrapper(main)